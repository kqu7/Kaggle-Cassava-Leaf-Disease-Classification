...
def compute_normalization_binary_search(activations, t, num_iters):
    ...
    effective_dim = torch.sum((normalized_activations>-1.0 / (1.0-t)).to(torch.int32),
    ...
    for _ in range(num_iters):
        ...
        lower = torch.reshape(lower * update + (1.0-update) * logt_partition,
                                shape_partition)
        upper = torch.reshape(upper * (1.0 - update) + update * logt_partition,
                                shape_partition)
